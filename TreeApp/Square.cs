...
namespace TreeApp
{
    ...
    {
        public Square(Point centre, int r, Circle c, ref DestDelegate destDelegate, double chance, string info, double price) : base(centre, r, c, ref destDelegate, chance, info, price)
        {
        ...
        public override void Print(Pen p, ref Graphics g, bool f, bool theEnd, SolidBrush drawBrush, bool visiblePrice, bool visibleChance, bool visibleNumber)
        {
            ...
            g.FillRectangle(drawBrush, centre.X - r, centre.Y - r, 2 * r, 2 * r);
